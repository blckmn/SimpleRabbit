...
namespace SimpleRabbit.NetCore.Service
{
    ...
    public abstract class OrderedKeyDispatcherAsync : OrderedQueueDispatcherAsync<MessageWrapper>
    {
        ...
        {
            return Task.FromResult(new MessageWrapper { BasicMessage = message });
        }
